...
:: Java
if "%builder_bitness%" == "32" (
call shellscriptlib :prepend_path PATH "C:\Program Files (x86)\Java\jre1.8.0_301\bin"
call shellscriptlib :prepend_path PATH "C:\Program Files (x86)\Java\jre1.8.0_301\bin\client"
set JAVA_HOME="C:\Program Files (x86)\Java\jdk1.8.0_74"
) else (
call shellscriptlib :prepend_path PATH "C:\Program Files\Java\jre1.8.0_301\bin"
call shellscriptlib :prepend_path PATH "C:\Program Files\Java\jre1.8.0_301\bin\server"
...
set BSF4OOREXX_HOME=C:\jlf\local\rexx\bsf4oorexx\BSF4ooRexx_install_v641-20210724-beta\bsf4oorexx
set BSF4OOREXX_JAR=bsf4ooRexx-v641-20210724-bin.jar
call :declare_bsf4oorexx_distribution
