...
:: Java
if "%builder_bitness%" == "32" (
call shellscriptlib :prepend_path PATH "C:\Program Files (x86)\Java\jre1.8.0_181\bin"
call shellscriptlib :prepend_path PATH "C:\Program Files (x86)\Java\jre1.8.0_181\bin\client"
set JAVA_HOME="C:\Program Files (x86)\Java\jdk1.8.0_74"
) else (
call shellscriptlib :prepend_path PATH "C:\Program Files\Java\jre1.8.0_181\bin"
call shellscriptlib :prepend_path PATH "C:\Program Files\Java\jre1.8.0_181\bin\server"
